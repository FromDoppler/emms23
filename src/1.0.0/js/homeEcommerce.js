...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const submitForm = async (e) => {
        ...
        if (isValidForm)
            //TODO: Agregar logica en el boton del form cuando este lista la maqueta
            try {
                await fetch(endPoint, {
                    ...
                    .then(resp => {
                        ...
                        //TODO: Agregar redireccion y cargado de interfaz cuando este lista la maqueta y las url
