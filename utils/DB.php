...
class DB
{
    ...
    public function insertSubscriptionDoppler($subscription)
    {
        ...
        $fields = "(email, list, form_id, register, firstname, phone, company, position, ecommerce, `digital-trends`,";
    ...
    public function saveRegistered($subscription)
    {
        ...
        if ($registered->fetchArray()) {
            //update
            $fields = "firstname ='" . $subscription['firstname'] . "', register ='" . $subscription['register'] . "', phase ='" . $subscription['form_id'] . "', phone ='" . $subscription['phone'] . "', company ='" . $subscription['company'] . "', position ='" . $subscription['position'] . "' ";
            ...
            //insert
            $fields = "(`email`, `phase`, `register`, `firstname`, `phone`, `company`, `position`, `ecommerce`, `digital-trends`, ";
