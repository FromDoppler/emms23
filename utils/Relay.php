        ...
        if (isset($user['tiketType'])) {
            ...
            switch ($phase) {
                case 'pre':
                    ...
                    break;
                case 'during':
                    $html = self::getDigitalTEmailTemplateDuring($user['encode_email']);
                    break;
                case 'post':
                    $html = self::getDigitalTEmailTemplatePost($user['encode_email']);
                    break;
            }
        }
        return $html;
                            ...
                            <td align="center" valign="top">
                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                    <tr>
                                        ...
                                        <th align="center" valign="middle" width="480" class="mobile mobile-pt">
                                            <a href="#" style="cursor: default"><img src="https://i.imgur.com/xVDAGAT.png"
                                                    alt="Logo EMMS Digital Trends" width="177"
                                                    style="width: 100%; max-width: 177px !important" /></a>
                                        </th>
                                        <th align="center" valign="middle" width="60" class="mobileOff">
                                            &nbsp;
                                        </th>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="background-color: #310E44">
                                        <table width="555" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody>
                                                <tr>
                                                    <th align="left" valign="middle" class="mobile" width="384">
                                                        <table width="384" cellpadding="0" cellspacing="0" border="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th align="left" valign="middle"
                                                                        style="font-family:  Helvetica, Arial, sans-serif;"
                                                                        class="mobile-center mobile-pt">
                                                                        <p
                                                                            style="Margin: 0;font-size: 16px;line-height: 22px;color:#EF2AAC;font-weight: 700; ">
                                                                            ¡Ya comenzamos! </p>
                                                                        <p
                                                                            style="Margin: 0;font-size: 22px;line-height: 22px;">
                                                                            &nbsp;</p>

                                                                        <p
                                                                            style="Margin: 0;font-size: 20px;line-height: 22px;color:#FFFFFF;font-weight: 700;max-width: 343px; ">
                                                                            Gracias por registrarte al mayor evento de
                                                                            Marketing Digital del año 
                                                                        </p>
                                                                        <p
                                                                            style="Margin: 0;font-size: 22px;line-height: 22px;">
                                                                            &nbsp;</p>
                                                                        <p
                                                                            style="Margin: 0;font-size: 15px;line-height: 22px;color:#FFFFFF;font-weight: 400; font-family:  Helvetica, Arial, sans-serif;max-width: 343px;">
                                                                            El EMMS Digital Trends regresó con todo y
                                                                            nuestros speakers y aliados ya están
                                                                            esperando por ti.
                                                                            <a href="https://goemms.com/digital-trends-registrado?utm_source=fromdoppler&utm_medium=email&utm_campaign=et-email-confirmacion-registro-emmsdt-during-23&dplrid=' . $encodeEmail . '"
                                                                                target="_blank"
                                                    ...
                                                    <th align="center" valign="middle" class="mobile" width="216">
                                                                    ...
                                                                    <th align="center" valign="middle"
                                                                        ...
                                                                        <p style="Margin: 0; "><a href="#"
                                                                                style="cursor: default;"><img
                                                                                    src="https://i.imgur.com/kemrkFV.png" alt="Asset cinema"
                                                                                    width="216"
                                                                                    style="width:100%;max-width:216px !important;"
                                                                                    class="mobile-margin-0"></a>
                                                                        </p>
                                                                    </th>
                                                                </tr>
                        ...
                        <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper">
                            <tbody>
                                <tr>
                                  ...
                                  text-align: center;
                                ">
                                                            <strong>¿Quieres acceder también al Networking y los
                                                                Workshop prácticos?</strong> ¡Aún estás a tiempo de
                                                            <strong>comprar tu entrada VIP</strong>! 
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                          ...
                                          margin: 0;
                                        ">
                                                                                            <img src="https://i.imgur.com/mNWsrcC.png"
                                                                                                alt="Ok tick" width="21"
                                                                                                style="
                                            width: 100%;
                                          ...
                                          ">
                                                                                    ...
                                                                                    <th width="260" align="left"
                                                                                        valign="top"
                                                                                        class="mobile  mobile-pt">
<img src="https://i.imgur.com/mNWsrcC.png"
                                                                                                alt="Ok tick" width="21" class="mobileOnInline desktopOff"
                                                                                                style="
                                            width: 100%;
                                            max-width: 21px !important;
                                            vertical-align: top;
...
<img src="https://i.imgur.com/mNWsrcC.png"
                                          ...
                                          max-width: 530px;
                                        ">
                                                                                            Obtén un certificado de
                                                                                            asistencia por cada workshop
                                                                                            que presencies
                                                                                        </p>
                                                                                    </th>
                                                                                </tr>
...
<img src="https://i.imgur.com/mNWsrcC.png"
                                        ...
                                        ">
                                                                                            Asiste a <strong>+15
                                                                                                Workshops
                                                                                                prácticos</strong> para
                                                                                            aprender de la mano de las
                                                                                            marcas y referentes más
                                                                                            destacados
                                                                                        </p>
                                                                                    </th>
                                                                                </tr>
...
<img src="https://i.imgur.com/mNWsrcC.png"
                                          ...
                                          max-width: 530px;
                                        ">
                                                                                            ¡Acceso a los Workshops para
                                                                                            siempre! Vuelve a verlos
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody>
                                                <tr>
                                                    <th align="center" valign="top" width="282" class="mobile">
                                                        <table ellpadding="0" cellspacing="0" border="0"
                                                            class="container">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="70"
                                                                        style="font-size: 70px; line-height: 70px" class="mobileOff">
                                                                        &nbsp;
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        ...
                                                                        style="font-family: Helvetica, Arial, sans-serif; color:#333333;">
                                                                        <p
                                                                            style="margin: 0; font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 22px;font-weight: 400;color:#333333;">
                                                                            <a href="https://goemms.com/digital-trends-registrado?utm_source=fromdoppler&utm_medium=email&utm_campaign=et-email-confirmacion-registro-emmsdt-during-23&dplrid=' . $encodeEmail . '#entradas"
                                                                                ...
                                                                                style="color: #33AD73;font-weight: bold; text-decoration: none;"
                                                                                class="link-hover">
                                                                                Consigue tu entrada aquí</a> (vamos… te
                                                                            costará menos de lo que pagarías una cena
                                                                            afuera 😉) y comienza a trabajar en tu
                                                        ...
                                                        <table ellpadding="0" cellspacing="0" border="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        style="font-family:  Helvetica, Arial, sans-serif;font-size: 13px;color:#FFFFFF;font-weight: 400;"
                                                                        class="mobile mobilePaddingBottom">
                                                                        <!-- Button : BEGIN -->
                                                                        <div>
                                                                            <!--[if mso]>
                                                    ...
                                                    <th align="left" valign="top" width="318" class="mobile ">
                                                        <a href="#" style="cursor: default !important;"><img
                                                                src="https://i.imgur.com/OOrrgNc.gif" alt="Workshop gif" width="318"
                                                                style="width:100%;max-width:318px !important;display: block;"></a>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <td height="40"
                                                        style="font-size:40px; line-height:40px; display: none;"
                                                        class="mobileOff">&nbsp;
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <td align="center" valign="top">
                                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <a href="#" style="cursor: default"><img src="https://i.imgur.com/Ag9OmJs.png"
                                                                alt="imagen separadora" width="21"
                                                                style="width: 100%; max-width: 21px !important"
                                                                class="img"></a>
                                                    </td>
                            ...
                            <td align="center" valign="top">
                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                    <tr>
                                        ...
                                        <th align="center" valign="middle" width="480" class="mobile mobile-pt">
                                            <a href="#" style="cursor: default"><img
                                                    src="https://i.imgur.com/xVDAGAT.png" alt="Logo EMMS Digital Trends"
                                                    width="177" style="width: 100%; max-width: 177px !important" /></a>
                                        </th>
                                        <th align="center" valign="middle" width="60" class="mobileOff">
                                            &nbsp;
                ...
                <tr>
                    <td align="center" valign="top" style="background-color: #310e44">
                        ...
                        ">
                            ...
                            max-width: 580px;
                          " class="mobile-title-fontsize">
                                                            Gracias por registrarte al mayor evento de Marketing Digital
                                                            del año🎙️
                                                        </p>
                                                        <p style="margin: 0; font-size: 25px; line-height: 25px">
                                                            &nbsp;
                          ...
                          ">
                                                            Pasó otra increíble edición del <a
                                                                ...
                                                                style="color: #33AD73;font-weight: bold; text-decoration: none;"
                                                                class="link-hover">
                                                                EMMS Digital Trends</a> y ¡ya puedes revivirla! Accede a
                                                            las conferencias y disfruta de todos los beneficios
                                                            exclusivos para la comunidad EMMS.
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                        ...
                        <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper">
                            <tbody>
                                <tr>
                                  ...
                                  text-align: center;
                                ">
                                                            ¡Continúa aprendiendo e inspirándote!
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                  ...
                                  text-align: center;
                                ">
                                                            Mientras te preparas para la edición 2024, disfruta de todo
                                                            el contenido VIP que nos ha dejado el EMMS Digital Trends
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                          ...
                                          margin: 0;
                                        ">
                                                                                            <img src="https://i.imgur.com/o5l4RIT.png"
                                                                                                alt="Emoji de herramientas"
                                                                                                width="28" style="
                                            width: 100%;
                                          ...
                                          ">
                                                                                    ...
                                                                                    <th width="555" align="left"
                                                                                        valign="top"
                                                                                        class="mobile  mobile-pt">
                                                                                        <img src="https://i.imgur.com/o5l4RIT.png"
                                                                                            alt="Emoji de herramientas"
                                                                                            width="28"
                                                                                            class="mobileOnInline desktopOff"
                                                                                            style="
                                            width: 100%;
                                            max-width: 28px !important;
                                            vertical-align: top;
                                        ...
                                        ">
                                                                                            <strong
                                                                                                style="font-size: 25px;">+15</strong>
                                                                                            Workshops prácticos con los
                                                                                            referentes y las marcas más
                                                                                            destacados
                                                                                        </p>
                                                                                    </th>
                                                                                </tr>
                                          ...
                                          margin: 0;
                                        ">
                                                                                            <img src="https://i.imgur.com/EEdoiwN.png"
                                                                                                alt="Emoji de cinema"
                                                                                                width="28" style="
                                            width: 100%;
                                            max-width: 28px !important;
                                        ...
                                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th align="left" valign="top" width="340" class="mobile ">
                                                        <a href="#" style="cursor: default !important;"><img
                                                                src="https://i.imgur.com/kpKB0sl.gif" alt="Workshop gif"
                                                                width="318"
                                                                style="width:100%;max-width:318px !important;display: block;"></a>
                                                    </th>
                                                    <th align="center" valign="top" width="260" class="mobile">
                                                        <table ellpadding="0" cellspacing="0" border="0"
                                                            class="container">
                                                            <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        ...
                                                                        style="font-family: Helvetica, Arial, sans-serif; color:#333333;">
                                                                        <p
                                                                            style="margin: 0; font-family: Helvetica, Arial, sans-serif;font-size: 20px;line-height: 27px;font-weight: 700;color:#333333;">
                                                                            Consigue tu entrada ahora y comienza a
                                                                            trabajar en tu estrategia digital 🚀
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                        ...
                        <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper">
                            <tbody>
                                <tr>
                                  ...
                                  text-align: center;
                                ">
                                                            Sigue aprendiendo y preparando tu estrategia digital para
                                                            hacer crecer tu negocio. ¡Nos vemos en el 2024!
                                                        </p>
                                                    </td>
                                                </tr>
                                        ...
                                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <a href="#" style="cursor: default"><img
                                                                src="https://i.imgur.com/oTQmrVs.png"
                                                                alt="imagen separadora" width="21"
                                                                style="width: 100%; max-width: 21px !important"
                                                                class="img"></a>
                                                    </td>
