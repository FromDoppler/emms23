...
$settings_phase = $mem_var->get("settings_phase_digital-trends");

if (!$settings_phase)
{
    $db = new DB(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
    $settings_phase = $db->getCurrentPhase('digital-trends')[0];
    $db->close();
    $mem_var->set("settings_phase_digital-trends", $settings_phase, CACHE_TIME);
}
?>
